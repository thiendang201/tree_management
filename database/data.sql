INSERT INTO `LoaiCay` (`tenLoaiCay`, `loaiRe`, `loaiThan`, `loaiLa`, `moTa`, `created_at`, `updated_at`) VALUES
('Cây cọ', 'rễ tốt, bám chặt vào mặt đất', 'thân cây cảnh nhỏ lớn chậm', 'tán rộng và xanh', 'Có kích thước cao tầm 0,5 – 2m , thân cây cảnh nhỏ lớn chậm, các tán rộng và xanh. Đối với các cây cọ lùn, chiều cao cây chỉ khoảng 1m trở lại, hệ tán khá phát triển.\nNhững chiếc lá cọ xòe to có hình giống như chiếc quạt. Khi lá quá lớn những thùy sẽ công hướng xuống mặt đất.\nLá cọ mọc thành cụm trông rất đẹp mắt. Lá non có màu xanh nhạt, rồi chuyển sang xanh đậm khi về già. Lá cọ khô có thể dùng lợp nhà hoạc trang trí.\nCứ sau một vòng đời lá, thân cọ sẽ có thêm 1 vòng mặt sẹo cọ. Bởi đó chính là các cành lá già tự rụng hoặc chặt đi.', NULL, NULL),
('Cây họ dầu', 'rễ trần', 'cây thân gỗ', NULL, NULL, NULL, NULL),
('Cây nhiệt đới', NULL, NULL, NULL, NULL, NULL, NULL),
('Cây họ bàng\r\n', NULL, NULL, NULL, NULL, NULL, NULL),
('Cây lá rộng', NULL, NULL, NULL, NULL, NULL, NULL);

INSERT INTO `CayXanh` (`tenCay`, `viTri`, `ngayTrong`, `trangThai`, `idLoaiCay`, `created_at`, `updated_at`) VALUES
('Cây sao đen', 'Hải Châu', '2021-06-09', '1', 'LC2', NULL, NULL),
('Cây hoa sữa', 'Hải Châu', '2021-06-09', '1', 'LC3', NULL, NULL),
('Cây phượng vĩ', 'Hải Châu', '2021-06-09', '1', 'LC3', NULL, NULL),
('Cây lim sét', 'Hải Châu', '2020-06-09', '1', 'LC5', NULL, NULL),
('Cây cọ dầu', 'Hải Châu', '2022-06-09', '1', 'LC1', NULL, NULL);

INSERT INTO `TinhTrangSauBenh` (`tenBenh`, `moTa`, `mucDo`, `ngayPhatBenh`, `ngayHet`, `idCay`, `created_at`, `updated_at`) VALUES
...
('Bệnh mốc xám', 'Bệnh mốc xám có tên gọi khoa học là Botrytis cinerea Persoon, có thể gây hại cho lá, cành, hoa. Bộ phận bị bệnh sẽ thối rửa và biến thành màu nâu. Trong điều kiện ẩm ướt, bộ phận bị bệnh xuất hiện lớp mốc màu xám. Thân cây bị bệnh có thể bị thối gãy, trường hợp nghiêm trọng cây có thể bị chết khô. Khi cây mắc bệnh, cần phải hạ nhiệt độ kịp thời, đặt cây ở nơi thoáng gió. Cây trồng nhiều năm, bón phân nitơ quá nhiều, trồng quá dày, thiếu ánh sáng, không thoát nước bệnh sẽ rất nặng. Ta thường gặp bệnh này trên cây hoa hồng, cây hoa sữa.\r\n\r\nKỹ thuật phòng trừ: cần khử trùng đất trước lúc trồng. Phun thuốc: Zineb 0.2% hoặc Daconil 0.2%, 10 ngày phun 1 lần, phun 2 ~ 3 lần.', '1', '2022-06-09 20:21:42', null, 'CX2', NULL, NULL);
...
INSERT INTO `NhanVien` (`tenNV`, `hinhAnh`, `CCCD`, `ngaySinh`, `SDT`, `email`, `diaChi`, `gioiTinh`, `trangThai`, `password`, `idQuyen`) VALUES
(N'Nguyễn Văn Anh',' ','263742934745','1998/03/04','0905426782','vananh@gmail.com', N'Quảng Nam',N'Nam',1,'a', 'Q1'),
(N'Nguyễn Thị Minh',' ','162537472534','1998/09/04','0237842384','thiminh@gmail.com', N'Đà Nẵng',N'Nữ',1,'a', 'Q2'),
(N'Trần Văn Nam',' ','671375127357','1998/06/04','0236462734','vannam@gmail.com', N'Quảng Nam',N'Nam',1,'a', 'Q3'),
(N'Nguyễn Ánh',' ','781232187368','1998/12/04','0263547234','nguyenanh@gmail.com', N'Đà Nẵng',N'Nữ',1,'a', 'Q3'),
(N'Võ Văn Kỳ',' ','871236872631','1998/03/04','0123182376','vanky@gmail.com', N'Quảng Nam',N'Nam',1,'a', 'Q3');

INSERT INTO `KeHoach` (`tenKeHoach`, `moTa`, `diaDiem`, `ngayBatDau`, `ngayKetThuc`, `doUuTien`, `idNVPhuTrach`, `trangThai`) VALUES	
(N'Tiả cây đón bão',N'Tiến hành cắt tỉa cây xanh đề phòng bão',N'Phường Hòa Thuận Tây','2022/04/26','2022/04/30',4,'NV1',3),
(N'Cắt tỉa cây đường Ông Ích Khiêm',N'Tiến hành cắt tỉa cây xanh lấn đường',N'Đường Ông Ích Khiêm','2022/05/01','2022/05/04',3,'NV2',3),
(N'Trồng thêm cây xanh cho đường Cao Thắng',N'Trồng thêm các cây xanh tạo bóng mát',N'Đường Cao Thắng','2022/06/14','2022/06/20',3,'NV3',2),
(N'Dọn dẹp cây sau bão',N'Tiến hành dọn dẹp cây xanh gãy do bão',N'Đường Nguyễn Tất Thành','2022/07/05','2022/07/10',5,'NV2',1),
(N'Tiả cây đón bão',N'Tiến hành cắt tỉa cây xanh đề phòng bão',N'Phường Thanh Bình','2022/07/01','2022/07/10',4,'NV1',1);

INSERT INTO `CongViec` (`tenCV`, `moTaTienDo`, `ngayBatDau`, `ngayKetThuc`, `ngayHoanThanh`, `idKeHoach`) VALUES 
	(N'Tỉa cây đón bão', N'Tiến hành cắt tỉa cây xanh đề phòng chống bão tại các tuyến đường trên 7,5m, công viên, vườn hoa, đài tưởng niệm trên địa bàn phường Hòa Thuận Tây,quận Hải Châu.', '2022/04/26','2022/04/30','2022/04/29','KH1'),
	(N'Trồng thêm cây', N'Tiến hành trồng thêm cây xanh ở công viên, vườn hoa, đài tưởng niệm trên địa bàn phường Hòa Thuận Tây,quận Hải Châu.', '2022/05/01','2022/05/04','2022/05/3','KH2'),
	(N'Tỉa cây', N'Tiến hành tỉa cây xanh ở công viên, vườn hoa, đài tưởng niệm trên địa bàn phường Hòa Thuận Tây,quận Hải Châu.','2022/06/14','2022/06/20', null,'KH3'),
	(N'Chăm sóc cây', N'Tiến hành chăm sóc cây xanh ở công viên, vườn hoa, đài tưởng niệm trên địa bàn phường Hòa Thuận Tây,quận Hải Châu.', '2022/07/05','2022/07/10', null, 'KH4'),
	(N'Đốn cây trồng cây mới', N'Tiến hành dốn cây trồng cây mới ở công viên, vườn hoa, đài tưởng niệm trên địa bàn phường Hòa Thuận Tây,quận Hải Châu.', '2022/07/01','2022/07/10', null, 'KH5');
...
INSERT INTO `suCo` (`tieuDe`, `loaiSuCo`, `moTa`, `idCay`, `trangThai`) VALUES 
		(N'Ngã cây', N'Ngã Cây', N'Hai cây bị ngã chắn ngang đường', 'CX1',0),
		(N'Gãy cành', N'Gãy cành', N'Cây xanh bị gãy cành dễ dẫn đến nguy hiểm cho người qua lại','CX2',1),
		(N'Ngã cây', N'Ngã Cây', N'Hai cây bị ngã chắn ngang đường','CX3',0),
		(N'Gãy cành', N'Gãy cành', N'Cây xanh bị gãy cành dễ dẫn đến nguy hiểm cho người qua lại','CX4',0),
		(N'Ngã cây', N'Ngã Cây', N'Hai cây bị ngã chắn ngang đường','CX5',0);
