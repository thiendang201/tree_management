...
const Button = ({
  ...
  if (type === "loading")
    return (
      <button
        className={`flex gap-1 items-center justify-center rounded-full p-1 bg-primary text-white text-[1.2rem] font-semibold min-w-[10rem]  ${className}`}
      >
        <svg
          role="status"
          className="inline w-8 h-8 text-white animate-spin fill-gray-300"
          viewBox="0 0 100 101"
          fill="none"
